...
/// };
///
/// // Add studios and tags
/// metadata.Studios.Add("Studio Example");
/// metadata.Tags.AddRange(new[] { "Romance", "Comedy", "Drama" });
///
/// // Add personnel
...
public sealed class Metadata
{
    ...
    /// Primary field for content classification and filtering.
    /// </summary>
    /// <example>
    /// Tags.AddRange(new[] { "Romance", "Comedy", "School", "Slice of Life" });
    /// </example>
    public List<string> Tags { get; set; } = new();

    /// <summary>
    /// Content genres reserved for future use.
    /// Currently unused - Tags field should be used instead.
    /// </summary>
    /// <example>
    /// Genres.AddRange(new[] { "Romance", "Comedy", "Drama" });
    /// </example>
